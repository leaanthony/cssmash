...
func TestCSSInline(t *testing.T) {
	cssTests := []struct {
		...
		{"color: #aabbcc00;", "color:#abc0"}, // RGB survives alpha 0; it is observable through interpolation
		...
		{"color: rgba(0%,0%,0%,0.2);", "color:#0003"},   // alpha .2 is exactly 51/255
		{"color: rgba(0,0,0,0.5);", "color:#00000080"},
		{"color: rgba(0,0,0,0.264705882);", "color:#0004"},
		{"color: rgba(0,0,0,0.025);", "color:#00000006"},
		{"color: rgba(255 0 0 / 1);", "color:red"},
		{"color: rgba(0 100% 50% / 100%);", "color:#00ff80"},
		{"color: rgba(0 100% 50% / 60%);", "color:#00ff8099"},
		{"color: rgb(20%,40%,60%,50%);", "color:#33669980"},
		{"color: rgb(0%,80%,100%,50%);", "color:#00ccff80"},
		{"color: rgb(1,2,3,90%);", "color:#010203e6"},
		{"color: rgb(1,2,3,.01);", "color:#01020303"},
		{"color: rgb(1,2,3,.0099);", "color:#01020303"},
		...
		{"color: hsla(0 100% 50% / 60%);", "color:#f009"},
		...
		{"color:rgba(255,255,255,0)", "color:#fff0"},           // #327: not `transparent`, which is rgba(0,0,0,0)
